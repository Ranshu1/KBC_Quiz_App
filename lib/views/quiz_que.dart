...
import 'package:kbc_quiz_app/views/wrong_ans.dart';
import 'package:kbc_quiz_app/views/win.dart';
import 'package:kbc_quiz_app/services/QuestionModel.dart';
import 'package:kbc_quiz_app/services/QuizQueCreator.dart';
...
//CHANGE THE TIMER SECONDS ACCORDING TO MONEY WON
  ...
  playLocal() async {
    ...
    if(widget.queMoney != 5000){
      ...
      player.open(Audio("assets/audio_effects/QUESTION.mp3"));
  ...
  playLock() async {
    ...
    final player = AssetsAudioPlayer();
    player.open(Audio("assets/audio_effects/LOCK_SCREEN.mp3"));
  }
//TASK - ADD OTHER SOUND EFFECTS TO THE APP
  ...
  playLosserSound() async {
    ...
    final player = AssetsAudioPlayer();
    player.open(Audio("assets/audio_effects/WORNG_ANSWER.mp3"));
  }
