...
class _QuizIntroState extends State<QuizIntro> {
  setLifeLAvail() async {
    ...
    player.open(Audio("assets\audio_effects\KBC_INTRO.mp3"));
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) =>
